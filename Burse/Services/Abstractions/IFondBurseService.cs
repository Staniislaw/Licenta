...
namespace Burse.Services.Abstractions
{
    public interface IFondBurseService
    {
        ...
        Task<byte[]> GenerateCustomLayout2(string filePath, List<FondBurse> fonduri, List<FormatiiStudii> formatiiStudii, decimal disponibilBM, double? valoareRomaniDePretutindeni = null);
